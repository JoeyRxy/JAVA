  ...
  return function (e) {
    ...
    var t = i(1),
      ...
      c = function (e, n, i) {
        ...
        u && (i = n);
        for (y in i) p = !s && g && void 0 !== g[y], h = (p ? g : i)[y], x = v && p ? a(h, t) : d && "function" == typeof h ? a(Function.call, h) : h, g && o(g, y, h, e & c.U), m[y] != h && r(m, y, x), d && w[y] != h && (w[y] = h)
      };
    ...
    e.exports = function (e, n, i, f, d, v, g) {
      ...
      if (O && (M = h(O.call(new e))) !== Object.prototype && M.next && (p(M, _, !0), t || a(M, x) || o(M, x, u)), A && S && "values" !== S.name && (k = !0, H = function () {
          return S.call(this)
        }), t && !g || !s && !k && z[x] || o(z, x, H), c[n] = H, c[_] = u, d)
        if (m = {
            values: A ? H : b("values"),
            keys: v ? H : b("keys"),
            entries: V
          }, g)
          for (w in m) w in z || r(z, w, m[w]);
    ...
    */
    ...
    l(l.S + l.F * !i(41)(function (e) {
      ...
      from: function (e) {
        ...
        if (d && (f = t(f, u > 2 ? arguments[2] : void 0, 2)), void 0 == g || s == Array && a(g))
          for (n = c(x.length), i = new s(n); n > v; v++) y(i, v, d ? f(x[v], v) : x[v]);
        else
          for (h = g.call(x), i = new s; !(l = h.next()).done; v++) y(i, v, d ? o(h, f, [l.value, v], !0) : l.value);
        return i.length = v, i
      }
    })
  }, function (e, n, i) {
    ...
    for (var t = i(69), l = i(21), r = i(10), o = i(1), a = i(8), c = i(13), y = i(0), p = y("iterator"), h = y("toStringTag"), x = c.Array, s = {
      ...
      var d, v = u[f],
        ...
        m = o[v],
        w = m && m.prototype;
      if (w && (w[p] || a(w, p, x), w[h] || a(w, h, v), c[v] = x, g))
        for (d in t) w[d] || r(w, d, t[d], !0)
    }
  }, function (e, n, i) {
    "use strict";
    var t = i(70),
        ...
        return r(p.prototype, {
          ...
          forEach: function (e) {
            ...
            for (var i, t = o(e, arguments.length > 1 ? arguments[1] : void 0, 3); i = i ? i.n : this._f;)
              for (t(i.v, i.k, this); i && i.r;) i = i.p
          },
          has: function (e) {
            return !!d(u(this, n), e)
          }
    ...
    var o = Object.assign || function (e) {
      ...
      x = function () {
        function e(n, i) {
          ...
          l(this, e), this.name = n, this.contents = i, this.tags = t, this.attrs = o({}, h.default, {
